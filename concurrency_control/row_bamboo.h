...
//    uint64_t increase_ts_ = increase_ts;
...
//        int update_node_thd_id = node;
//        auto thd_txn_ = glob_manager->get_txn_man(update_node_thd_id);
//        if (thd_txn_ != nullptr) {
//            if (thd_txn_->get_ts() <= increase_ts_){
//                increase_ts_ = increase_ts_+1;
//                thd_txn_->set_ts(increase_ts_);
//            }
//        }
