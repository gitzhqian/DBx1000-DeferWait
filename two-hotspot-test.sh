...
## vary position  fixed one at top    two write     last retire = 0
# sed -i '8s/.*/#define   THREAD_CNT                       20/g' config.h
# sed -i '159s/.*/#define REQ_PER_QUERY				             16/g' config.h
# sed -i '316s/.*/#define TEST_TARGET                      begin2W1/g' config.h
...
# cc_name=(BAMBOO)
## vary position  fixed one at top    two write      last retire = 0.15
# sed -i '8s/.*/#define   THREAD_CNT                       20/g' config.h
# sed -i '159s/.*/#define REQ_PER_QUERY				             16/g' config.h
# sed -i '316s/.*/#define TEST_TARGET                      begin2W1/g' config.h
# sed -i '165s/.*/#define POS_HS                           SPECIFIED/g' config.h
...
## WOUND_WAIT NO_WAIT WAIT_DIE BAMBOO SILO TICTOC HEKATON HOTSPOT_FRIENDLY
# cc_name=(HOTSPOT_FRIENDLY)
### vary position  fixed one at end    two write     last retire = 0
# sed -i '8s/.*/#define   THREAD_CNT                       20/g' config.h
# sed -i '159s/.*/#define REQ_PER_QUERY				             16/g' config.h
# sed -i '316s/.*/#define TEST_TARGET                      end2W1/g' config.h
# sed -i '165s/.*/#define POS_HS                           SPECIFIED/g' config.h
# sed -i '173s/.*/#define READ_HOTSPOT_RATIO               0.0/g' config.h
...
# HOTSPOT_FRIENDLY  BAMBOO
# cc_name=(BAMBOO)
## vary position  fixed one at end    two write     last retire = 0.15
# sed -i '8s/.*/#define   THREAD_CNT                       20/g' config.h
# sed -i '159s/.*/#define REQ_PER_QUERY				             16/g' config.h
# sed -i '316s/.*/#define TEST_TARGET                      end2W1/g' config.h
# sed -i '165s/.*/#define POS_HS                           SPECIFIED/g' config.h
...
# WOUND_WAIT NO_WAIT WAIT_DIE BAMBOO SILO TICTOC HEKATON HOTSPOT_FRIENDLY
 cc_name=(HOTSPOT_FRIENDLY)
# vary transaction size    random    two write     last retire = 0
 sed -i '8s/.*/#define   THREAD_CNT                       20/g' config.h
 sed -i '316s/.*/#define TEST_TARGET                      random2W/g' config.h
 ...
 # vary transaction size  2, 5, 10, 15, 20, 25, 30
 for((a=0;a<${#cc_name[@]};a++))
 do
   sed -i '44s/.*/#define CC_ALG 						            '${cc_name[$a]}'/g' config.h
...
# HOTSPOT_FRIENDLY  BAMBOO
# cc_name=(BAMBOO)
## vary transaction size    random    two write     last retire = 0.15
# sed -i '8s/.*/#define   THREAD_CNT                       20/g' config.h
# sed -i '316s/.*/#define TEST_TARGET                      random2W/g' config.h
# sed -i '165s/.*/#define POS_HS                           RANDOM/g' config.h
# sed -i '173s/.*/#define READ_HOTSPOT_RATIO               0.0/g' config.h
...
# HOTSPOT_FRIENDLY  HOTSPOT_FRIENDLY
# cc_name=(HOTSPOT_FRIENDLY)
## vary transaction size    random    50% write     last retire = 0
# sed -i '8s/.*/#define   THREAD_CNT                       20/g' config.h
# sed -i '316s/.*/#define TEST_TARGET                      random2W1R1W/g' config.h
# sed -i '165s/.*/#define POS_HS                           RANDOM/g' config.h
